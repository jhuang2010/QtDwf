...
class Library(object):
    ...
    def _load(self):
        ...
        if library_path is None: # a workaround solution to the 'can't find library' error on Yocto os caused by the SDK not installed in the find_library() search path
            if not os.path.exists('/opt/picoscope/lib/libusbpt104.so.2'):
                ...
                library_path = '/opt/picoscope/lib/libusbpt104.so.2' 
