...
import sys
from PyQt5.QtWidgets import QApplication, QWidget, QVBoxLayout, QHeaderView, QTableWidgetItem, QMessageBox
from PyQt5.QtCore import QFile, Qt, pyqtSignal, pyqtSlot
